...
serpentine.py
victormcm-picoctf@webshell:~$ cat serpentine.py 
...
victormcm-picoctf@webshell:~$ python serpentine.py 
...
```
## Notas Adicionales
Modificamos el archivo para poner la función que revela la bandera.
## Referencias