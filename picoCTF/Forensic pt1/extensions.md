...
## Solución
```bash
victormcm-picoctf@webshell:~$ file flag.txt 
flag.txt: PNG image data, 1697 x 608, 8-bit/color RGB, non-interlaced
victormcm-picoctf@webshell:~$ xxd flag.txt | head
...
victormcm-picoctf@webshell:~$ mv flag.txt flag.png
victormcm-picoctf@webshell:~$ open flag.png 
```

![[Pasted image 20241001205634.png]]
## Notas Adicionales
